...
class TempeClassifier:
    ...
    def __init__(self) -> None:
        ...
        self._model.fc = Linear(2048, len(self.labels_array))
    ...
    def load_model(self) -> None:
        ...
        save_path = os.path.join(os.getcwd(), "saved_model.pth")
        # Let our model load the model parameters from the file path defined in the first line.
        self._model.load_state_dict(load(save_path, map_location=self._device)['model_params'])
